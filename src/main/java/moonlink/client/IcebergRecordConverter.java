/*
 * Reference files for type conversions
 */
...
//   IcebergRecordConverter(Table table, IcebergSinkConfig config) {
...
//               Type type = IcebergSchemaUtils.inferIcebergType(recordFieldValue, config);
//               if (type != null) {
...
//                   String parentFieldName =
//                       structFieldId < 0 ? null : tableSchema.findColumnName(structFieldId);
//                   Type type = IcebergSchemaUtils.toIcebergType(recordField.schema(), config);
...
//                       IcebergSchemaUtils.needsDataTypeUpdate(tableField.type(), recordField.schema());
